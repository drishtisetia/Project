...
public class SellerProductAPI {
	...
	@GetMapping(value = "/getProductBySellerEmailId/{sellerEmailId}")
	public ResponseEntity<List<ProductDTO>> getProductBySellerEmailId(@PathVariable String sellerEmailId) throws EKartException {
	sellerEmailId=sellerEmailId+".com";
	List<ProductDTO> productDTO = sellerProductService.getProductBySellerEmailId(sellerEmailId);
	return new ResponseEntity<>(productDTO, HttpStatus.OK);
	}
